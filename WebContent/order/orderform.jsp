	...
	<form method="post" id="orderForm" name="orderForm" action="/AspireStore/orderpayment.aspire" onsubmit="return payment()">
		<div>
				...
				<div>
					...
					<table>
						<tr>
							...
							<td>
								<span>
									<label> <input type="text" id="orderer_name" name="orderer_name" value="<c:out value="${pageScope.USER_INFO.user_name}"/>">
									</label>
								</span>
							</td>
						</tr>
						<tr>
							...
							<td>
								<p id="orderer_phone">
									<input type="text" class="text" id="orderer_mobile_1" name="orderer_mobile_1" maxlength="3" value="<c:out value="${pageScope.USER_INFO.mobile1 }" />">
									-
									<input type="text" class="text" id="orderer_mobile_2" name="orderer_mobile_2" maxlength="4" value="<c:out value="${pageScope.USER_INFO.mobile2 }" />">
									-
									<input type="text" class="text" id="orderer_mobile_3" name="orderer_mobile_3" maxlength="4" value="<c:out value="${pageScope.USER_INFO.mobile3 }" />">
								</p>
							</td>
						</tr>
						<tr>
							...
							<td>
								<p id="orderer_general">
									<select name="orderer_general_1_select" id="orderer_general_1_select">
									...
									<input type="text" class="text" id="orderer_general_2" name="orderer_general_2" maxlength="4" value="<c:out value="${pageScope.USER_INFO.general2 }" />">
									-
									<input type="text" class="text" id="orderer_general_3" name="orderer_general_3" maxlength="4" value="<c:out value="${pageScope.USER_INFO.general3 }" />">
								</p>
							</td>
						</tr>
						<tr>
							<th>이메일 주소</th>
							<td>
								<input type="email" id="orderer_email" name="orderer_email" />
							</td>
					</table>
				</div>
					...
					<table>
						<tr>
							...
							<td>
								<div>
									<span>
										<label><input type="radio" class="radio" id="delivery_method" name="delivery_method" value="1" />일반택배</label>
									</span>
									<span>
										<label><input type="radio" class="radio" id="delivery_method" name="delivery_method" value="2" />편의점 픽업</label>
									</span>
								</div>
							</td>
						</tr>
					...
					<table>
						<tr>
							...
							<td>
								<div>
									<span>
										<label><input type="text" class="text" id="recepient_name" name="recepient_name" /></label>
									</span>
									<span>
										<input type="button" id="setRecepientInfo" name="setRecepientInfo" onclick="javascript:setRecepientData()" value="주문자 정보와 동일">
									</span>
								</div>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<p id="recepient_phone">
									<input type="text" class="text" id="recepient_mobile_1" name="recepient_mobile_1" maxlength="3" />
									-
									<input type="text" class="text" id="recepient_mobile_2" name="recepient_mobile_2" maxlength="4" />
									-
									<input type="text" class="text" id="recepient_mobile_3" name="recepient_mobile_3" maxlength="4" />
								</p>
							</td>
						</tr>
						<tr>
							...
							<td>
								<p id="recepient_general">
									<select name="recepient_general_1_select" id="recepient_general_1_select">
										<option value="" selected>선택 안함</option>
										<option value="02">02</option>
										<option value="031">031</option>
										<option value="032">032</option>
									...
									<input type="text" class="text" id="recepient_general_2" name="recepient_general_2" maxlength="4" />
									-
									<input type="text" class="text" id="recepient_general_3" name="recepient_general_3" maxlength="4" />
								</p>
							</td>
						</tr>
					</table>
					...
					<table>
						<tr>
							...
							<td>
								<div>
									<span>
										<label><input type="radio" class="radio" name="select_address" id="select_address" value="latest_address" onclick="javascript:getLastestAddress()" />최근 배송지</label>
									</span>
									<span>
										<label><input type="radio" class="radio" name="select_address" id="select_address" value="address_list" onclick="javascript:showAddressListModal()" />주소록</label>
									</span>
									<span>
										<label><input type="radio" class="radio" name="select_address" id="select_address" value="write_new_address" onclick="javascript:clearAddressCodeValue()" />신규 입력</label>
									</span>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td>
								<p>
									<span>
										우편번호
										<input type="text" class="text" id="postal_code" name="postal_code" maxlength="5" />
									</span>
									<span>
										<input type="button" name="searchAddress" id="searchAddress" value="주소 검색" />
									</span>
								</p>
								<p>
									도로명 주소
									<input type="text" class="text" id="road_name_address" name="road_name_address" />
								</p>
								<p>
									지번 주소
									<input type="text" class="text" id="number_address" name="number_address" />
								</p>
								<p>
									상세 주소
									<input type="text" class="text" id="detail_address" name="detail_address" />
				...
				<div>
					<table>
						<tr>
							<th>신용카드</th>
							<td>
								<input type="radio" class="radio" name="payment_method" id="payment_method" value="1" />
								일반 신용카드(체크카드 포함)
							</td>
						</tr>
						<tr>
							<th>계좌이체</th>
							<td>
								<input type="radio" class="radio" name="payment_method" id="payment_method" value="2" />
								계좌이체
								<input type="radio" class="radio" name="payment_method" id="payment_method" value="3" />
								무통장 입금
							</td>
						</tr>
						<tr>
							<th>간편결제</th>
							<td>
								<input type="radio" class="radio" name="payment_method" id="payment_method" value="4" />
								카카오 페이
								<input type="radio" class="radio" name="payment_method" id="payment_method" value="5" />
								페이코
							</td>
						</tr>
					</table>
			...
			<div>
				<div>요청사항</div>
				<div>
					<textarea id="requested_term" name="requested_term" cols="50" rows="10"></textarea>
				</div>
			</div>
